//go:build grpccloudprovider
// +build grpccloudprovider
...
// DefaultCloudProvider for grpc-only build is grpccloudprovider.
const DefaultCloudProvider = cloudprovider.GrpcProviderName

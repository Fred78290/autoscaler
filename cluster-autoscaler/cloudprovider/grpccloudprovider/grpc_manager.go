...
func newGrpcManager(configReader io.Reader, opts config.AutoscalingOptions, _ cloudprovider.NodeGroupDiscoveryOptions, rl *cloudprovider.ResourceLimiter, nodeGroups []*NodeGroupDef) (*GrpcManager, error) {
	var cfg GrpcConfig

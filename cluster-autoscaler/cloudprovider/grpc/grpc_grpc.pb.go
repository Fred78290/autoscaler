...
const (
	...
	CloudProviderService_GetNodeGpuConfig_FullMethodName         = "/grpccloudprovider.CloudProviderService/GetNodeGpuConfig"
)
...
type CloudProviderServiceClient interface {
	...
	GetNodeGpuConfig(ctx context.Context, in *GetNodeGpuConfigRequest, opts ...grpc.CallOption) (*GetNodeGpuConfigReply, error)
}
...
func (c *cloudProviderServiceClient) GetNodeGpuConfig(ctx context.Context, in *GetNodeGpuConfigRequest, opts ...grpc.CallOption) (*GetNodeGpuConfigReply, error) {
	out := new(GetNodeGpuConfigReply)
	err := c.cc.Invoke(ctx, CloudProviderService_GetNodeGpuConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CloudProviderServiceServer interface {
	...
	GetNodeGpuConfig(context.Context, *GetNodeGpuConfigRequest) (*GetNodeGpuConfigReply, error)
...
func (UnimplementedCloudProviderServiceServer) GetNodeGpuConfig(context.Context, *GetNodeGpuConfigRequest) (*GetNodeGpuConfigReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetNodeGpuConfig not implemented")
}
...
func _CloudProviderService_GetNodeGpuConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetNodeGpuConfigRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CloudProviderServiceServer).GetNodeGpuConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CloudProviderService_GetNodeGpuConfig_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CloudProviderServiceServer).GetNodeGpuConfig(ctx, req.(*GetNodeGpuConfigRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CloudProviderService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetNodeGpuConfig",
			Handler:    _CloudProviderService_GetNodeGpuConfig_Handler,
		},
	},

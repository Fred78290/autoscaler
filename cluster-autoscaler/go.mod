...
require (
	...
	k8s.io/legacy-cloud-providers v0.21.4
...
replace k8s.io/code-generator => k8s.io/code-generator v0.21.4
...
replace k8s.io/cri-api => k8s.io/cri-api v0.21.4
...
replace k8s.io/mount-utils => k8s.io/mount-utils v0.21.4

...
echo 'address: "unix:/var/run/cluster-autoscaler/aws.sock"' > /tmp/grpc-config.yaml
...
--kubeconfig=${HOME}/Projects/autoscaled-masterkube-aws/cluster/aws-ca-k8s/config \
--max-nodes-total=9 \
--cores-total=0:32 \
--memory-total=0:48 \
